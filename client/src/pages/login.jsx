      ...
      xl:px-5 lg:flex-row">
                <div class="flex flex-col items-center w-full pt-5 pr-10 pb-10 pl-10 lg:pt-10 lg:flex-row ">
                    ...
                    <div class="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
                        <form class="flex flex-col items-start justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl relative z-10">
                            <p class="w-full text-4xl font-medium text-center leading-snug font-serif">Login</p>
                            <div class="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">

                                <p class="bg-white  pr-2  pl-2 -mt-3  font-medium text-gray-600 absolute">Login as:</p>
                                <div class="relative">
                  ...
                  rounded-lg transition duration-200 hover:bg-indigo-600 ease">Submit</button>
                        ...
                        <div className='bg-white-700 relative m-3 text-center font-medium'>
                            <p>Do not have an Account ? <Link to='/signup' className='text-indigo-500 font-bold'>Register</Link></p>
